...
export class FlatRentSdk {
  ...
  private _areAllDatesAvailable(flat: IFlatRentPlace, dateRange: Date[]): boolean
  private _formatFlatObject(flat: IFlatRentPlace, nightNumber: number): IFormattedFlatRentPlace
